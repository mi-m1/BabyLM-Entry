...
# sequence = ["aochildes", "bnc_spoken", "cbt_train", "children_stories", "gutenberg", "open_subtitles", "qed", "simple_wikipedia", "switchboard", "wikipedia"]
# random.shuffle(sequence)

# print(sequence)
# ['gutenberg', 'children_stories', 'wikipedia', 'open_subtitles', 'simple_wikipedia', 'bnc_spoken', 'qed', 'aochildes','cbt_train', 'switchboard']
